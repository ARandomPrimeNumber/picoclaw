...
echo ==============================================================================
echo.
echo     [94m____   ____ ______  ____  [0m
echo    [94m/ __ \ /  _// ____/ / __ \  [0m
echo   [94m/ /_/ / / / / /     / / / /  [0m
echo  [94m/ ____/ / / / /___  / /_/ /  [0m
echo [94m/_/    /___/ \____/  \____/  [0m
echo.
echo ==============================================================================
echo.
...
echo.
set /p "N_NAME=Model Name [String] (e.g. OpenAI GPT-4): "
set /p "N_MOD=Model [String] (e.g. openai/gpt-4o): "
set /p "N_BASE=API Base [URL String] (Optional): "
set /p "N_KEY=API Key [String]: "
set /p "N_PROX=Proxy [URL String] (Optional): "
set /p "N_AUTH=Auth Method [String] (Optional, e.g. Bearer Token): "
set /p "N_CONN=Connect Mode [String] (Optional): "
set /p "N_MAX=Max Tokens Field [String] (Optional): "
set /p "N_RPM=RPM [Integer] (Optional): "
...
if "%GW_ACTION%"=="Start Gateway" (
    ...
    start "PicoClaw Gateway Monitor" cmd /c ".\LAUNCHERS\Prebuilt\picoclaw.exe gateway > gateway.log 2>&1"
    timeout /t 2 >nul
) else (
